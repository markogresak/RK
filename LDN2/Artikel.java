...
public class Artikel {
	 ...
	 */
	 public Element getXMLElement(Document doc, boolean addId) {
		 ...
		 // Naredi element kolicina, dodaj text in ga vstavi v artikel
		 ...
		 // Naredi element skladisce, dodaj text in ga vstavi v artikel
	...
	public String toString() {
		...
		return String.format("Artikel [ID=%d]: %s, %d kos%s v skladišču %d", getId(), getNaziv(), getKolicina(), koncnica, getSkladisce());
	}
}